...
public:
    ...
    // used for the terminal implementation
    void showAllEntries() const;
    // used for the qt implementation
...
private:
    ...
    std::string formatGameTimestamp(long long timestamp) const;
    ...
    std::string dragonQueryHandler(RiotApi& riotApi, const std::string& puuid, const std::string& gameName, const std::string& tagLine) const;
};
